export default function PlaceForm({visible, isPlaceFormShow}) {
  return (
    <div className={visible? " flex justify-center h-screen items-center bg-gray-200 antialiased": 'hidden'}>
