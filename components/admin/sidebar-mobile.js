...
export default function SidebarMobile({ sidebarOpen }) {
  return (
    <div
      className={`transition-all duration-500 fixed h-full  top-0 z-20 w-72 pt-20 ${
        sidebarOpen ? "left-0 " : " -left-72 md:left-0 "
      } md:z-0`}
    >
      <div className="h-full py-8 pl-10 bg-xanhlo">
        <div className="flex items-center p-2 mr-10 space-x-4 bg-indigo-600 rounded-md">
          ...
          <div>
            <Link href="/admin">
              <a className="text-lg font-semibold text-white">Dashboard</a>
            </Link>
          </div>
        </div>
        <div className="mt-8 ">
          <ul className="">
            <li>
              <Link href="/admin/place">
                <a className="flex items-center p-3 text-sm font-semibold text-gray-500 transition duration-200 bg-xanhlo">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="">
              <Link href="/admin/user">
                <a className="flex items-center p-3 text-sm font-semibold text-gray-500 transition duration-200">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6 mr-4 text-gray-400 transition duration-200 hover:text-indigo-600"
                    fill="none"
