...
export default function Review({ place, reviews }) {
  return reviews.map((review) => (
    <ReviewItem place={place} key={review.id} review={review} />
  ));
}
...
const ReviewItem = ({ review, place }) => {
  ...
  return (
    <div className="w-full p-4 border-0 border-gray-200 divide-y divide-gray-300 md:p-8 ">
        ...
        <div className="w-full m-4 -mt-1 md:ml-6 ">
          ...
          <div className="flex items-center justify-between mt-4 text-sm text-gray-600 fill-current">
            ...
            <div className="flex items-center">
              ...
              >
                <svg
                  className={`w-3 h-3 ${upvoted ? "text-TimNhat" : null} `}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                >
              ...
              >
                <svg
                  className={`w-3 h-3 ${downvoted ? "text-TimNhat" : null} `}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                >
